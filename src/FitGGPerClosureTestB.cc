...
void FitGGPerAlphaMC(int region, int category) {   
  ...
  if(opts.getBoolVal("lowMass")) {
    ...
    if (category==2) {        // no btag category - chiara: qui metto i tagli mjj come per 1btag, che sono piu' loose
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200");
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==1");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==1");
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==2");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==2");
    }
    ...
    if (category==2) {        // no btag category
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300");
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==1");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==1");
      ...
      else if (region==1) data = (RooDataSet*)data->reduce("massggnewvtx>140 && massggnewvtx<=180 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==2");
      else if (region==2) data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==2");
    }
  }
  ...
  char fitconfig[200];
  if(opts.getBoolVal("lowMass")) {  
    if (region==0) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyLowMass_closure2_LS.config");     
    if (region==1) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyLowMass_closure2_HS.config");    
    if (region==2) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyLowMass_closure2_SR.config");    
  } else {
    if (region==0) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyHighMass_closure2_LS.config");    
    if (region==1) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyHighMass_closure2_HS.config");    
    if (region==2) sprintf(fitconfig,"fitconfig/fitBackgroundOnlyHighMass_closure2_SR.config");    
  }
...
void PlotGGPerAlpha_closure_lowMass(int category) {    
  ...
  if (category==0)                 
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==2");
  else if (category==1) 
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200 && btagCategory==1");
  else if (category==2) 
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<700 && mggjj>200");
...
void PlotGGPerAlpha_closure_highMass(int category) {
  ...
  RooDataSet *data = getDataSet2(datasetnameB, treename, category);
  if (category==0)
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==2");
  else if (category==1)
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300 && btagCategory==1");
  else if (category==2)
    data = (RooDataSet*)data->reduce("massggnewvtx>130 && massggnewvtx<=140 && mjj>90 && mjj<170 && mggjj<1000 && mggjj>300");
  TTree *treeData = dataset2tree(data);
